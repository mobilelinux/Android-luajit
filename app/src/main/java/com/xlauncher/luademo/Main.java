...
public class Main extends Activity implements OnClickListener,
		OnLongClickListener {
	private final static int LISTEN_PORT = 6666;
	...
	private String errorReason(Integer error) {
		...
		if (error.equals(LuaState.LUA_ERRMEM))
			return "Out of memory";
		else if (error.equals(LuaState.LUA_ERRSYNTAX))
			return "Syntax error";
		else if (error.equals(LuaState.LUA_ERRRUN))
			return "Runtime error";
		else if (error.equals(LuaState.LUA_YIELD))
			return "Yield error";
		else {
